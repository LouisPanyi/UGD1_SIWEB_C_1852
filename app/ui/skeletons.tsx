...
export function ReservationSkeleton() {
  return (
    <div>
      <div className="mb-4">
        <div className="text-1xl mb-1 bg-gray-200 h-6 w-36 rounded-md" />
        <div className="bg-gray-200 h-4 w-24 rounded-md mb-2" />
        <div className="bg-gray-200 h-4 w-24 rounded-md" />
      </div>
      <div className="w-full mb-8">
        <div className="mt-4 flex items-center justify-between gap-2 md:mt-8">
          <div className="bg-gray-200 h-10 w-full max-w-90" />
          <div className="bg-gray-500 h-10 w-60" />
        </div>
      </div>
    </div>
  );
